...
import {
  ...
  getCorporateScheduleDetailsSuccess,
} from "@Redux";
import { ROUTES } from "@Routes";
import {
  ADD_DESIGNATION_RULES,
  CREATE_CORPORATE_SCHEDULE_RULES,
  CREATE_KNOWLEDGE_GROUP_VARIANT_RULES,
...
function Designation() {
  ...
  console.log(
    "corporateSchedules---------->",
    JSON.stringify(corporateSchedules)
  );
  ...
  const [changeColorButton, setChangeColorButton] =
    useState<any>(interviewDurations);
  ...
  useEffect(() => {
    ...
    dispatch(getCorporateScheduleDetailsSuccess(undefined));
  }, []);
  ...
  return (
    <>
      ...
      ) : corporateSchedules?.details?.corporate_jd_items.length > 0 ? (
        <div className="pt-4 mx-sm-7">
          ...
          <div className="row pt-5 ">
            {cardData && cardData.length > 0 ? (
              ...
              <div
                className={
                  "d-flex  justify-content-center align-items-center mx-auto my-auto "
                }
                style={{
                  height: "60vh",
                }}
      ...
      >
        <div className="px-md-6 px-3 ">
          <Heading
            heading={"Create Opening"}
            style={{ fontSize: "26px", fontWeight: 800, margin: 0 }}
          />
          <div className="text-default pt-1 font-weight-500">
            Input job details, specifying qualifications, requirements,
            interview duration
          </div>
              ...
              <div className="col-sm-4">
                ...
                <select
                  ...
                  className={`form-control ${
                    experience.length === 0 ? "text-default" : "text-black"
                  } rounded-sm `}
                >
