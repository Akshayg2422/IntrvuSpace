import { Button, ViewMore } from "@Components";
...
function ScheduleLiteItem({
  ...
  const { job_description: { position, experience, details }, candidate_details: { selected_candidates, total_candidates }, vacancies, interview_duration, is_view_more } = item
