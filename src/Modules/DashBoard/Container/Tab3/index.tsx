          ...
          <Row>
            <Col className={'col-6'}>
              <div className="pt-6">
                ...
                <div className={'text-black h2 font-weight-bolder'}>Seamless Registration</div>

                <p className={'custom-text-color'} style={{ maxWidth: '400px' }}>
                Get started by providing your basic information - name, age, designation, and working experience. Share an optional description to highlight your strengths and aspirations.
                </p>
              </div>
            </Col>
