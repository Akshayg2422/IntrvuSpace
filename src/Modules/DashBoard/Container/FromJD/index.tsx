              ...
              {jdItem &&
                ...
                jdItem.map((item: any, index: any) => {
                  ...
                  const modifiedSchedules = schedules.filter((each: any) => {
                    const { is_started, is_complete, id, report_analytics } =
                      each;
                  ...
                  const copyInterviewLink =
                    schedules &&
                    schedules.length > 0 &&
                    schedules[0].custom_interview_link;

                  const basic_info =
                    proceedInterview?.custom_interviewee_details?.basic_info;

                  const basicInfo =
                    basic_info && basic_info.first_name ? basic_info : null;
                  ...
                  return (
                    <Card
                      className="mt-5 rounded-sm mx-md-5"
                      style={{
                        borderWidth: "1px",
                        borderColor: "#d3deff",
                    ...
                    >
                      <div className="px-md-4 py-md-3">
                              ...
                              {proceedInterview ? (
                                <div>
                                  <Button
                                    ...
                                    className={
                                      "px-md-5 border border-primary rounded-sm"
                                    }
                                    text={
                                      proceedInterview.is_started
                                        ? "Resume Interview"
                                        : "Start Interview"
                                    }
                                    onClick={() => {
                                      proceedInterviewHandler(
                                        proceedInterview?.id
                                      );
                                    }}
                                  />
                                ...
                                <div>
                                  <div className="row d-flex align-items-center mt-1">
                                    ...
                                    <h5
                                      ...
                                      className="mb-0 text-secondary font-weight-bolder ml-2"
                                    >
                                        ...
                                        {details
                                          ...
                                          .map((paragraph, index) => (
                                            <React.Fragment key={index}>
                                              {index > 0 && <br />}{" "}
                                              {/* Add <br /> between paragraphs except for the first one */}
                                              {paragraph}
                                            </React.Fragment>
                                          ))}
                                        <span
                        ...
                        {modifiedSchedules && modifiedSchedules.length > 0 && (
                          <div
                            className="mt-3 px-md-4 pt-md-5"
                                ...
                                .map((each: any, index: number) => {
                                  ...
                                  return (
                                    <div className="d-flex flex-column">
                                      ...
                                      <div className="d-flex">
                                        <div className="col-3">
                                          <h5 className="col m-0 p-0 text-secondary">
                                            {"Interview " +
                                              (index + 1) +
                                              demoDisplayName}
                                          </h5>
                                          <h5 className="col mb-0 pl-1 font-weight-normal text-default">
                                            {(is_complete
                                              ? "Completed "
                                              : "Created at ") +
      ...
      <div className="p-5">
        ...
        >
          <div className={"m-md-5 mt-sm-0 mt-5"}>
            <div className="display-4 text-secondary font-weight-bolder mt--6 mb-md-5">
              {"Create Interview"}
              <p
            ...
            <div className="text-center mt-md-6">
              <Button
                className={"rounded-sm px-md-5 px-sm-0 px-6"}
                size="md"
