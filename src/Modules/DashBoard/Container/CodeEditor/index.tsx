...
import { CodeEditorWindow, OutputWindow } from "@Modules";
...
const CodeEditor = React.forwardRef(({ ref, onSubmit, value, showAddSubmit = false, isLoading, showExpand = false, codeOutput, codeSubmit, courseIde, isFromStudentTask = false, isMyTask = false, isGuestTask = false, ...props }: Props) => {
            ...
            <div className={`row  mx-1 `}>
                            ...
                            <div className=''>
                                ...
                                <div className='row'>
                                    ...
                                    <div className=' row ml-4 '>
                                        <img src={courseIde === 'PY' ? icons.pythonLogo : icons.defaultImage} height={23} className="" alt='...' />
                                            ...
                                            : <Image src={statusButton} height={23} className="mr-3 "
                                                onClick={() => {
                                                    ...
                                                    if (javaScript || styleCSS || htmlValue) {
                                                        ...
                                                        showToast('Please type some code to run', 'error')
                                                    }
                                                }
                                                }
                                            />
                ...
                <div className={`col-sm-6 ${isExpandCodeEditor ? '' : "pt-sm-0 pt-xl-0 pt-3"}`} style={{ paddingLeft: '0px', paddingRight: '0px', }}>
                    ...
                    <OutputWindow
                        ide={courseIde}
                        iframeId={'output'}
                        outputDetails={outputDetails ? outputDetails : codeOutput}
                        theme={themeMode}
                        onClearClick={() => {
